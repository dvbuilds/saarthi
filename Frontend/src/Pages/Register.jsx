      ...
      <div className="w-full lg:w-[500px] shrink-0 bg-white flex flex-col justify-center px-12 py-10 relative z-10 shadow-[-4px_0_32px_rgba(10,22,40,0.07)]">
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            ...
            <input type="text" name="fullName" placeholder="e.g. Alex Mehta"
        ...
        <p className="text-center font-inter text-[12px] text-slate-400 mt-4 leading-relaxed">
          ...
          <Link to="/terms" className="text-blue no-underline hover:underline">Terms</Link> and{" "}
          <Link to="/privacy" className="text-blue no-underline hover:underline">Privacy Policy</Link>.
        </p>
      </div>
    </div>
  );
